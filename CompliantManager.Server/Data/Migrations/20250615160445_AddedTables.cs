...
namespace CompliantManager.Server.Data.Migrations
{
    ...
    public partial class AddedTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationMethodId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NotificationMethodName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationMethod", x => x.NotificationMethodId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PreferedNotificationMethod",
                columns: table => new
                {
                    NotificationMethodId = table.Column<int>(type: "int", nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreferedNotificationMethod", x => new { x.CustomerId, x.NotificationMethodId });
                    table.ForeignKey(
                        name: "FK_PreferedNotificationMethod_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PreferedNotificationMethod_NotificationMethod_NotificationMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClaimId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ExpectedAction = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreferedNotificationMethod_NotificationMethodId",
                table: "PreferedNotificationMethod",
